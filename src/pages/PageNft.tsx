        ...
        {success && !isLoading && (
          <>
              ...
              <Box className="NFT-heading-block">
                <Box className="row">
                  <Box className="col-xl-6">
                    <Box className="client-img-block">
                      <span>
                        <Avatar
                          sx={{
                            width: 149,
                  ...
                  <Box className="col-xl-6">
                    <Box className="header-block-right">
                      <a href="" className="commen-btn">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="17.038"
            ...
            <Box className="NFT-item-listing">
              ...
              <Box className="row">
                {nfts.map((item: any, index: any) => (
                  <Box key={index} className="col-xxl-3 col-xl-4 col-sm-6 NFT-item-box">
